...
public class ColumnDefinition
{
    ...
    /// <summary>
    /// The raw SQL data type name of this column as reported by the DATA_TYPE
    /// schema collection (e.g. 'geometry', 'geography', 'nvarchar'). Retained so
    /// custom type handling (such as MS SQL spatial support) can distinguish types
    /// that do not have a corresponding SqlDbType enum value.
    /// </summary>
